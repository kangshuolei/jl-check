...
public class PoiWordUtil {  
  ...
  //新增一行
    ...
    public void setDocumentbackground(XWPFDocument document, String bgColor) {  
    	CTBackground bg = (CTBackground) (document.getDocument().isSetBackground() ? document  
                .getDocument().getBackground() : document.getDocument()  
                .addNewBackground());  
        ((XWPFRun) bg).setColor(bgColor);  
    }  
  ...
  public static void main(String[] args) throws Exception {
		...
		FileInputStream in=new FileInputStream("c:\\blackDoc.docx");
		XWPFDocument xdoc = new XWPFDocument(in);  
	  System.out.println(xdoc.hashCode());
  }
}
