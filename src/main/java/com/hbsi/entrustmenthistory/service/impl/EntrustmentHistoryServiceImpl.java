...
public class EntrustmentHistoryServiceImpl implements EntrustmentHistoryService {
	 ...
	 */
	@Override
	public Response<Integer> deleteEntrustmentHistory(Integer id) {
		int message = 0;
		try {// 添加成功
			message = 1;
			logger.info("删除成功");
	 ...
	 */
	@Override
	public Response<Integer> saveEntrustmentHistory(EntrustmentHistory record) {
	 ...
	 */
	@Override
	public Response<EntrustmentHistory> selectEntrustmentHistory(Integer id) {
		EntrustmentHistory entrustHistory = new EntrustmentHistory();// 存放查询的数据

		try {
			// 成功
			entrustHistory = entrustmentHistoryMapper.selectByPrimaryKey(id);
			logger.info("查询成功,得到的表为:{}", entrustHistory);
		...
		return new Response<EntrustmentHistory>(entrustHistory);
	}
	 ...
	 */
	@Override
	public Response<Integer> updateEntrustmentHistory(EntrustmentHistory record) {
		int message = 0;
