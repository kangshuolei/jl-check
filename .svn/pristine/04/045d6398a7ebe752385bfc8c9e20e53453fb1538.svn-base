...
import com.hbsi.dao.WireAttributesIso24082004Mapper;
import com.hbsi.dao.WireAttributesMT7162006Mapper;
import com.hbsi.dao.WireAttributesYbt45422016Mapper;
//import com.hbsi.dao.WireAttributesMT7162006Mapper;
...
public class StructureServiceImpl implements StructureServie {
	...
	@Autowired
	private WireAttributesYbt45422016Mapper wireAttributesYbt45422016Mapper;
	@Autowired
	...
	@Autowired
	private WireAttributesIso24082004Mapper wireAttributesIso24082004Mapper;

	/**
	 * 
	 * @author lijizhi 根据ID,显示所有的结构信息
	 * @return
	 * @date 12.7
	 */
	@Override
		...
		if (regularNum != null && !regularNum.equals("")) {// 判断是否为空
			...
			if (strNew.equals("200672017")) {
				try {// 查询成功
					...
					for (WireAttributesGbt200672017 Gbt200672017 : wireAttributesGbt200672017Mapper
							.selectWireAttributesGbt200672017Structure()) {
				...
				try {// 查询成功
					this.success();
					for (WireAttributesGbt201182017 Gbt201182017 : wireAttributesGbt201182017Mapper
							.selectWireAttributesGbt201182017Structure()) {
				...
				try {// 查询成功
					this.success();
					for (WireAttributesGBT89182006 GBT89182006 : wireAttributesGBT89182006Mapper
							.selectWireAttributesGBT89182006Structure()) {
			...
			}else if (strNew.equals("123854200212008")) {
				try {// 查询成功
					this.success();
					for (WireAttributesEn123852002 En123852002 : wireAttributesEn123852002Mapper
							.selectWireAttributesEn123852002Structure()) {
						String structure = En123852002.getStructure();
						structureAll.add(structure);
					}
					return new Response<List<?>>(structureAll);
				} catch (Exception e) {// 查询失败
			...
			else if (strNew.equals("45422016")) {
				try {// 查询成功
					this.success();
					for (WireAttributesYbt45422016 Ybt45422016 : wireAttributesYbt45422016Mapper
							.selectAllStruc()) {
						String structure = Ybt45422016.getStructure();
						structureAll.add(structure);
					}
					return new Response<List<?>>(structureAll);
				} catch (Exception e) {// 查询失败
			...
			else if (strNew.equals("24082004")) {
				try {// 查询成功
					this.success();
					for (WireAttributesIso24082004 Iso24082004 : wireAttributesIso24082004Mapper.selectAllStruc()) {
						String structure = Iso24082004.getStructure();
						structureAll.add(structure);
					}
					return new Response<List<?>>(structureAll);
				} catch (Exception e) {// 查询失败
			...
			else if (strNew.equals("92011")) {
				try {// 查询成功
					this.success();
					for (WireAttributesApi9a2011 Api9a2011 : wireAttributesApi9a2011Mapper
							.selectAllStruc()) {
						String structure = Api9a2011.getStructure();
						structureAll.add(structure);
					}
					return new Response<List<?>>(structureAll);
				} catch (Exception e) {// 查询失败
				...
				try {// 查询成功
					this.success();
					for (WireAttributesYbt53592010 MT7162006 : wireAttributesYbt53592010Mapper
							.selectWireAttributesYbt53592010Structure()) {
