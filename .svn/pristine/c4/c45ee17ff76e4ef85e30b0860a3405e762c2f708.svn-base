...
public enum ExceptionEnum {
	...
	SAMPLE_NUMBER_UPDATE_FAILED("00005512", "修改试样编号失败"),
	...
	//历史委托单号模块
	ENTRUSTMENTHISTORY_SAVE_FAILED("00015110","委托单号保存失败"),
	ENTRUSTMENTHISTORY_DELETE_FAILED("00015120","历史委托单号删除失败"),
	ENTRUSTMENTHISTORY_UPDATE_FAILED("00015130","历史委托单号更新失败"),
	ENTRUSTMENTHISTORY_SELECT_FAILED("00015140","历史委托单号查询失败"),
	ENTRUSTMENTHISTORYNUM_SAVE_FAILED("00015160","历史委托单号添加失败"),

	
	//拆股实验结论保存中出现的异常
	BREAK_CONCLUSION_SAVE_FAFILED("00016110","拆股实验结论保存失败"),
	BREAK_CONCLUSION_UPDATE_FAFILED("00016120","拆股实验结论更新失败"),
	BREAK_CONCLUSION_SELECT_FAFILED("00016130","拆股实验结论查询失败"),
	BREAK_CONCLUSION_DELETE_FAFILED("00016140","拆股实验结论删除失败"),
	
	//机器数据
	MACHINE_SAVE_FAILED("0008111", "添加失败"),
	MACHINE_SELECT_FAILED("0008121", "查询列表失败"),
	MACHINE_DELETE_FAILED("0008131", "删除失败"),
	
	//直径
	DAIMETER_INPUT_EMPOTY("000017110","直径实测值不能为空");
	;
